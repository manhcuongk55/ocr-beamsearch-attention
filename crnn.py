...
from keras.layers import Input, Dense, Bidirectional, Dropout, MaxPooling2D
...
def get_model(input_shape, training, finetune):
    ...
    lstm1 = Bidirectional(LSTM(256, return_sequences=True, kernel_initializer='he_normal', name='lstm1', dropout=0.25,
                               recurrent_dropout=0.25))(inner)
    lstm2 = Bidirectional(LSTM(256, return_sequences=True, kernel_initializer='he_normal', name='lstm2', dropout=0.25,
                               recurrent_dropout=0.25))(lstm1)
